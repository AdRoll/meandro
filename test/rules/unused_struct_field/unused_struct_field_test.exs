defmodule MeandroTest.UnusedStructField do
  ...
  @test_directory_path "test/rules/unused_struct_field/examples/"
  ...
  test "emits warnings on structs where all fields are unused" do
    ...
    expected_text1 = "The field lat from the struct MeandroTest.Examples.UnusedStructFields.Unused is unused"
    expected_text2 = "The field long from the struct MeandroTest.Examples.UnusedStructFields.Unused is unused"
  ...
  test "emits warnings on structs where at least one field is unused" do
    ...
    files_and_asts = TestHelpers.parse_files([file])
    expected_text = "The field lat from the struct MeandroTest.Examples.UnusedStructFields.OneUnused is unused"
  ...
  describe "the struct is only used to pattern match a function header" do
    ...
    test "emits a warning when a field is unused in a pattern match" do
      ...
      expected_text = "The field long from the struct MeandroTest.Examples.UnusedStructFields.Source is unused"
      files_and_asts = TestHelpers.parse_files([file])
